        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              Apartments, Plots or villas, we offer properties across
              Karnataka’s most sought after locations.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              We simplify buying, selling, and investing with honest advice and
              clear communication.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              Our team is committed to prompt responses and seamless experiences
              at every step.
            </p>
          </div>
        </div>
